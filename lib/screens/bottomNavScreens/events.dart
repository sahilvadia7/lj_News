...
class events extends StatefulWidget {
  ...
  @override
  _events_state createState() => _events_state();
}

class _events_state extends State<events> {
  List<Posts> postList = [];
  List<Posts> tempList = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // body:
      // Container(
      //   child: postList.isEmpty? const Text("No post available") :  ListView.builder(
      //       itemCount: postList.length,
      //       itemBuilder: (_, index){
      //         return postsUI(postList[index].image,
      //             postList[index].description,
      //             postList[index].publisher,
      //             postList[index].date,
      //             postList[index].time);
      //       }),
      //   // child:
          ...
          children: [
            ...
            Expanded(
              child: FirebaseAnimatedList(
                query: postRef.orderByChild('postType').equalTo('Events'),
